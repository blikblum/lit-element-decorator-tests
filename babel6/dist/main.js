...
const shady_render_render = (result, container, options) => {
    ...
    const needsScoping = container instanceof ShadowRoot &&
        compatibleShadyCSSVersion && result instanceof template_result_TemplateResult;
    ...
    if (firstScopeRender) {
        ...
        if (part.value instanceof template_instance_TemplateInstance) {
...
var _class, _temp2, _dec, _desc, _value, _class2, _descriptor;
...
let src_MyApp = (_temp2 = _class = class MyApp extends lit_element_LitElement {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), this.count = 0, this.increment = () => {
      this.count++;
    }, _temp;
  }
...
let src_MyCounter = (_dec = property({ type: Number }), (_class2 = class MyCounter extends lit_element_LitElement {
  constructor(...args) {
    var _temp3;

    return _temp3 = super(...args), _initDefineProp(this, 'value', _descriptor, this), _temp3;
  }
...
customElements.define('my-app', src_MyApp);
customElements.define('my-counter', src_MyCounter);
